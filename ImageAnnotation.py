...
cv2.rectangle(image_rgb, top_left1, bottom_right1, (0,255,0), 3)
...
cv2.putText(image_rgb, "Center 2", (center2_x - 40, center2_y - 40), font, 0.7, (0,0,255), 2, cv2.LINE_AA)
...
plt.title("Annotated Image With Regions, Centers, and Bi-Directional Arrow")
plt.axis("off")
plt.show()